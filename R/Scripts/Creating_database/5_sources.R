...
<<<<<<< HEAD:R/Scripts/Creating_database/6_sources.R
## Save
write_csv(source_list, file = "R/Data_outputs/full_database/source_list.csv")
=======



>>>>>>> parent of e809cbe (Redoing taxonomy with tol, making changes to units in spreadsheet, removing duplicate sources and formtting original source columns):R/Scripts/Creating_database/5_sources.R
